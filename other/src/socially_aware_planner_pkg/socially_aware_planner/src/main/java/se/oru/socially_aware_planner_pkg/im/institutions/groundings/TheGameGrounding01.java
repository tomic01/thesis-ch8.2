...
public class TheGameGrounding01 extends Grounding {

	// Create Grounding
	public TheGameGrounding01(TheGameInstitution gameInst, ThePEIS2Domain theDomain) {
		super(gameInst, theDomain);

		// Ga
		addRelationGa("Runner", "mbot14");
